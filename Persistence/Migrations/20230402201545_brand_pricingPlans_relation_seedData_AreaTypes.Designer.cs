...
namespace Persistence.Migrations
{
    ...
    [Migration("20230402201545_brand_pricingPlans_relation_seedData_AreaTypes")]
    partial class brand_pricingPlans_relation_seedData_AreaTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AreaType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("753d36d1-2776-454b-944b-4b5619493c20"),
                        ...
                        new
                        {
                            Id = new Guid("0089483d-d9c6-4f66-b57f-e7a7f4ee4e99"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Office"
                        },
                        new
                        {
                            Id = new Guid("f113b30e-ecb9-47e3-b050-8bbd7d528dfb"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Room"
                        },
                        new
                        {
                            Id = new Guid("72ff82c1-21c1-4e81-8362-ba4db854f7f0"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Virtual"
                        },
                        new
                        {
                            Id = new Guid("ecfcd31c-4b6e-4671-998f-3d8fc278bdb4"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Event"
                        });
            ...
            modelBuilder.Entity("Domain.Entities.PricingPlan", b =>
                {
                    ...
                    b.Property<int>("PricingPlanTimeSpan")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Brand", b =>
                {
                    b.HasOne("Domain.Entities.Photo", "Logo")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.CustomService", b =>
                {
                    b.HasOne("Domain.Entities.Visit", null)
